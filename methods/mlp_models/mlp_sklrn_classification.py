...
iris = pd.read_csv('methods/datas/iris.csv')

def train_mlp_sklrn_class():
    
    label_encoder = LabelEncoder()
    to_predict = label_encoder.fit_transform(iris['Species'])
    ...
    return(score, conf_matrix, clsf_report, loss_curve)