...
with st.expander("# **How to use the app**:grey_question:"):
    ...
    st.write("To predict your input with a ML or DL model, follow this steps bellow")
    st.write("1) Click on the expand icon on the up left side of this page")
    st.write("2) Chose your model type: Machine Learning / Deep Learning")
    st.write("3) Chose your ML/DL learning model")
    st.write("4) Give your inputs by slicing the bars of parameters")
    st.write("5) Click on the predict button and then HERE WE GOO !!")
